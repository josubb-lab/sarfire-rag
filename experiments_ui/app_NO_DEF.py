#!/usr/bin/env python3
"""
SARFIRE-RAG v4.0 FINAL - Estilo NotebookLM
            ...
            with gr.Row():
                with gr.Column(scale=2):
                    mode_selector = gr.Radio(
                        ...
                        info="Selecciona qué agente quieres usar"
                    )
                ...
                with gr.Column(scale=1):
                    external_checkbox = gr.Checkbox(
                        ...
                        value=False,
                        info="Buscar en web si DTF-13 no tiene información (solo Formador y Simulador)"
                    )
        ...
        with gr.Column(scale=3):
            ...
            gr.HTML("""
                <div class="info-card">
                    ...
                    El Director analiza tu consulta y la dirige al agente más apropiado automáticamente.</p>
                    
                    <p><strong>Formador</strong><br>
                    Responde consultas técnicas y proporciona explicaciones basadas en el DTF-13.</p>
                    
                    <p><strong>Simulador</strong><br>
                    Genera escenarios operativos realistas y evalúa tus decisiones.</p>
                </div>
            """)
            ...
            gr.HTML("""
                <div class="info-card">
                    ...
                    <p><strong>Consultas Formador:</strong></p>
                    <ul>
                        <li>¿Qué es el Puesto de Mando Avanzado?</li>
                    ...
                    <ul>
                        <li>Genera un escenario de incendio nocturno</li>
                        <li>Crea un caso con viento fuerte</li>
            ...
            gr.HTML("""
                <div class="info-card">
                    ...
                    <p><strong>Fallback externo:</strong> Tavily API</p>
                    <p><strong>Umbral relevancia:</strong> 0.5</p>
                </div>
            """)
...
if __name__ == "__main__":
    print("🚀 Lanzando SARFIRE-RAG v4.0 FINAL...")
    print("📱 URL: http://localhost:7860")
    print("🎨 Diseño: NotebookLM Style")
    print("\n✨ Características:")
    print("  • 3 modos de operación (Automático, Formador, Simulador)")
    print("  • Fallback a fuentes externas (Tavily)")
    print("  • Evaluación de escenarios")
    print("  • Diseño profesional Material Design")
